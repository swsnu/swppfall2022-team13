...
const NewsDetailPage = () => {
  ...
  const [newsArticlesLeft, setLeftContents] = useState<NewsArticleType[]>([
    {
      id: 1,
      url: "/news/1",
      journal_name: "한겨레",
    ...
    },
    {
      ...
      title: "시진핑 中주석 선물 판다 암수 한쌍, 대한항공 특별기로 3일 입국",
      detail_text:
  ...
  const [newsArticlesRight, setRightContents] = useState<NewsArticleType[]>([
    {
      id: 5,
      url: "/news/5",
      journal_name: "조선일보",
      ...
      title: "홍준표 '文, 개 3마리도 건사 못하면서 나라 5년 통치'",
      detail_text:
    ...
    },
    {
      ...
      title: "풍산개 반환 논란 빚은 문재인, 반려동물 등록제 위반 의혹",
      detail_text:
    ...
    },
    {
      ...
      title: "본좌청년회 모집공고! 허경영을 지지하는 청년들의 모임~",
      detail_text:
