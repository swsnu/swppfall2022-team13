  ...
  return (
    <Box sx={{ display: 'flex' }}>
      ...
      <Drawer variant="permanent" open={open}>
        ...
        <Divider />
        <List>
          {['Political News', 'Politicians', 'Petition', 'Quora'].map((text, index) => (
            <ListItem onClick={() => navigate(index === 0 ? "/main/" :
            index === 1 ? "/politician/" :
            index === 2 ? "/petition/" :
            "/quora/")} key={text} disablePadding sx={{ display: 'block' }}>
              <ListItemButton
                sx={{
                  minHeight: 48,
