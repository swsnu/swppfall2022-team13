...
const PetitionCreatePage = () => {
  ...
  const clickCreateHanler = async () => {
    ...
    if (isLogin && response.data.id !== 2) {
      ...
      if (photo_url === "") {
        petitionData.photo_url =
          "https://kgmi-am.sagacom.com/files/2021/05/Petition-clipart-webicized-1200x768.jpg";
      }
      ...
      <div className="petition-create">
        ...
        <Form>
          <Form.Group as={Row} className="input-class" id="title-input-form">
            <Form.Label id="title-text">
              <h5>Title</h5>
              <div>
                <Form.Control
                  id="title-input"
                  type="text"
                  placeholder="청원할 글의 제목을 작성해 주세요."
                  value={title}
          ...
          <Form.Group as={Row} className="input-url-class" id="url-input-form">
            <Form.Label id="url-text">
              <h5>Image</h5>
              <div>
                <Form.Control
                  id="url-input"
                  type="text"
                  placeholder="게시할 사진의 URL을 붙여넣기 해주세요. 사진이 없으면 비워주세요. 기본 사진을 넣어 드릴게요."
                  value={photo_url}
          ...
          <Form.Group as={Row} className="input-class" id="content-input-form">
            <Form.Label id="content-text">
              <h5>Content</h5>
              <div>
                <Form.Control
                  id="content-input"
                  type="text"
                  placeholder="청원 내용을 자세히 작성해 주세요."
                  value={content}
