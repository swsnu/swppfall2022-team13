...
const QuoraDetailPage = () => {
  ...
  const quora = quoraState.quoras.find(
    (value: any) => value.id === currQuoraId
  );
  ...
  return (
    //POLITICIAN LIST랑 연동하여 사진, 정보 등 가져오기!!!
    ...
    <div className="background_red">
      ...
      <div className="card">
        ...
        <div className="card-body">
          ...
          <p>
            <a href="/petition" className="btn btn-primary">
              Back
            </a>
            &nbsp; &nbsp;
            <button
